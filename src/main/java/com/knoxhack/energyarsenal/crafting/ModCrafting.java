...
public final class ModCrafting {
	...
	public static void initCrafting() {
		...
		GameRegistry.addRecipe(new ItemStack(Main.itemdarksteelplate, 4), new Object[] {"## ", "## ", "   ", '#', Main.itemdarksteelingot});
		...
		//GameRegistry.addRecipe(new ItemStack(Main.itemteslasword, 1), new Object[] {" # ", " I ", " C ", '#', Main.itemdarksteelingot, 'I',Main.itemtoolhandle, 'C',Main.itemcapacitorTesla});
		...
		GameRegistry.addRecipe(new ItemStack(Main.itemrfsword, 1), new Object[] {" # ", " I ", " C ", '#', Main.itemdarksteelingot, 'I',Main.itemtoolhandle, 'C',Main.itemcapacitorRF});
