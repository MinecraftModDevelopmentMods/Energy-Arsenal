...
public class ItemFESword extends ItemFE
{
  ...
  ToolMaterial WOODTOOL = EnumHelper.addToolMaterial("WOODTOOL", 3, 1000, 1.0F, 8.0F, 30);
    ...
    public ItemFESword(ToolMaterial material)
    {
        ...
        setUnlocalizedName("energyarsenal.itemfesword");
        setRegistryName("itemfesword");
