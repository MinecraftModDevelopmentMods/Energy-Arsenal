...
public class ItemTeslaCapacitorCreative extends ItemTesla
{
	private EntityPlayer player;

	public ItemTeslaCapacitorCreative()
    {
        super();
        setUnlocalizedName("energyarsenal.itemteslacapacitorcreative");
        setRegistryName("itemteslacapacitorcreative");
	...
	{
		return (1 - (double) TeslaUtils.getStoredPower(stack, null) / (double) TeslaUtils.getCapacity(stack, null));
    }
		...
		if(!world.isRemote && entity instanceof EntityPlayer){
            ...
            for(int i = 0; i < player.inventory.getSizeInventory(); i++){
                ...
                if(slot != null){
                    ...
                    if(take > 0){
                    TeslaUtils.takePower(stack, null, 0, false);
                    }  
                }
            }
        }
    ...
    public ICapabilityProvider initCapabilities(final ItemStack stack, NBTTagCompound nbt) {
        return new BaseTeslaContainerProvider(new BaseTeslaContainer(5000000, 5000, 5000){
            @Override
