...
public class ItemFECapacitor2 extends ItemTesla
{
    public long cost = 10;
    ...
    public ItemFECapacitor2()
    {
        super();
        setUnlocalizedName("energyarsenal.itemfecapacitortier2");
        setRegistryName("itemfecapacitortier2");
    }
