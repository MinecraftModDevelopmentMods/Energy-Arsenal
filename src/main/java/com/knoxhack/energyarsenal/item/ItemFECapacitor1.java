...
public class ItemFECapacitor1 extends ItemTesla
{
    public long cost = 10;
    ...
    public ItemFECapacitor1()
    {
        super();
        setUnlocalizedName("energyarsenal.itemfecapacitortier1");
        setRegistryName("itemfecapacitortier1");
    }
