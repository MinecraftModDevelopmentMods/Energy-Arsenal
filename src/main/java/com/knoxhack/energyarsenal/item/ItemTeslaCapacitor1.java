...
public class ItemTeslaCapacitor1 extends ItemTesla
{
	private EntityPlayer player;

	public ItemTeslaCapacitor1()
    {
        super();
        setUnlocalizedName("energyarsenal.itemteslacapacitortier1");
        setRegistryName("itemteslacapacitortier1");
